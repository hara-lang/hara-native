...
@HaraNativeBinding(namespace = "std.native", name = "Runtime", methods = {"load-string", "macroexpand-1", "gensym", "ns-publics", "ns-aliases", "ns-find", "ns-create", "ns-name", "var-sym", "current", "snapshot", "vars", "namespaces", "namespace", "module", "alias-state", "intern", "intern-var", "eval-in", "eval"})
...
@HaraNativeBinding(namespace = "std.native", name = "Edn", methods = {"read", "read-forms", "read-forms-spanned", "write", "pretty"})
...
@HaraNativeBinding(namespace = "std.native", name = "Command", methods = {"create", "config", "install", "uninstall", "routes", "snapshot", "restore", "reset", "closed?", "close", "parse", "dispatch", "run"})
...
@HaraNativeBinding(namespace = "std.native", name = "Base", methods = {"list", "vector", "vec", "set", "hash-map", "hash-set", "map-entry", "bytes", "atom", "delay", "pointer", "symbol", "keyword", "uuid", "identical?", "reduced", "unreduced", "hash", "apply", "resolve", "namespace", "current-namespace", "select-namespace", "def", "struct", "mutable", "protocol", "with-declaration", "extend", "multimethod", "method", "field", "number?", "long?", "vector?", "pair?", "map-entry?", "satisfies?", "supports-method?", "special-symbol?", "type", "instance?"})
@HaraNativeBinding(namespace = "std.native", name = "Algo", methods = {"sort", "deque", "ordered-map", "ordered-set", "priority-map", "queue", "sorted-map", "sorted-set", "trie", "deque?", "ordered-map?", "ordered-set?", "priority-map?", "queue?", "sorted-map?", "sorted-set?", "trie?"})
@HaraNativeBinding(namespace = "std.native", name = "Iter", methods = {"seq", "seq-deferred", "iter", "iter-finite?", "iter-materialize", "iter-next?", "iter-next", "iter-close", "iter-concat", "iter-map", "iter-filter", "iter-take-while", "iter-drop-while", "iter-mapcat", "iter-keep", "iter-interpose", "iter-interleave", "iter-every?", "iter-any?", "iter-take", "iter-drop", "iter-zip", "iter-cycle", "iter-partition-pair", "iter-partition-all", "iter-partition", "iter-range", "iter-constantly", "iter-repeatedly", "iter-iterate"})
@HaraNativeBinding(
