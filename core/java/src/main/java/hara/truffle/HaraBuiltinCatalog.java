...
@HaraNativeBinding(namespace = "std.native", name = "Base", methods = {"list", "vector", "vec", "set", "hash-map", "hash-set", "map-entry", "bytes", "atom", "delay", "pointer", "symbol", "keyword", "uuid", "identical?", "reduced", "unreduced", "hash", "apply", "resolve", "namespace", "current-namespace", "select-namespace", "def", "struct", "mutable", "protocol", "with-declaration", "extend", "multimethod", "method", "field", "number?", "long?", "vector?", "pair?", "map-entry?", "satisfies?", "special-symbol?", "type", "instance?"})
